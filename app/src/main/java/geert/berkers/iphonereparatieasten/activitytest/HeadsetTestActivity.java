...
public class HeadsetTestActivity extends AppCompatActivity {
    ...
    private void handleNoHeadsetPluggedIn() {
        txtInfo.setText("Plug een headset in.");
        txtQuestion.setText("Is de headset ingeplugd maar niet herkend?");
    ...
    private void handleHeadsetPluggedIn() {
        txtInfo.setText("Er wordt een geluid afgespeeld");
        txtQuestion.setText("Hoort u geluid door uw headset?");
